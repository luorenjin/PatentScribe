---
description: "Use when modifying PatentMate React components, TypeScript frontend, AI prompts/providers, structured disclosure output, export flows, or storage integration. Covers yarn-first workflow, aiService ownership, typed patent models, and language adaptation based on the source document."
name: "PatentMate Frontend And AI Conventions"
...
# PatentMate Frontend And AI Conventions
  - "package.json"
  - "README.md"
  - "GEMINI.md"
---
