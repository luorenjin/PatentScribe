...
export const Logo = ({ size = 24, className = "" }: { size?: number; className?: string }) => {
  return (
    ...
    >
      ...
      <path d="M260 210L362 210L362 312L260 312L260 210Z" fill="white" fill-opacity="0.2"/>
      <circle cx="362" cy="312" r="40" fill="#818CF8"/>
      <path d="M342 292L382 332M382 292L342 332" stroke="white" stroke-width="8" stroke-linecap="round"/>
    </svg>
  );
};
